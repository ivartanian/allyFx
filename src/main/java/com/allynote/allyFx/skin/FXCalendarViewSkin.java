...
public class FXCalendarViewSkin extends SkinBase<FXCalendarView>
{
	...
	private FXCalendarContent fxCalendarContent;
	 ...
	 */
	public FXCalendarViewSkin(FXCalendarView pControl)
	{
		super(pControl);
		
		fxCalendarContent = new FXCalendarContent(pControl);
		getChildren().add(fxCalendarContent);
